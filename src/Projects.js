        ...
        <div className="container portfolio">
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6" style={{width: '18rem;'}}>
                  <img className="img-fluid" alt="SmorgasChord" src={require("./img/smorgaschord.png")} />
                ...
                <div className="col-lg-4 col-sm-6" style={{width: '18rem;'}}>
                  <img className="img-fluid" alt="workdaySched" src={require("./img/workdayscheduler.png")} />
                  <div className="card-body">
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6" style={{width: '18rem;'}}>
                  <img className="img-fluid" alt="passwrodGen" src={require("./img/passwordgen.png")} />
                  <div className="card-body">
                ...
                <div className="col-lg-4 col-sm-6" style={{width: '18rem;'}}>
                  <img className="img-fluid" alt="quizGen" src={require("./img/quiz.png")} />
                  <div className="card-body">
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6" style={{width: '18rem;'}}>
                  <img className="img-fluid" alt="emptyProject" src={require("./img/4.jpg")} />
                  <div className="card-body">
